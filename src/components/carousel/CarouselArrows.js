...
const leftIcon = (customIcon, isRTL) => (
  <Iconify
    icon={customIcon ? customIcon : "meteor-icons:arrow-left-long"}
    sx={{
      width: 20,
      height: 20,
      // backgroundColor: '#dc8aaa',
      // transform: " scaleX(-1)",
...
const rightIcon = (customIcon, isRTL) => (
  <Iconify
    icon={customIcon ? customIcon : "meteor-icons:arrow-right-long"}
    sx={{
      width: 20,
      height: 20,
      // backgroundColor: "#dc8aaa",F
